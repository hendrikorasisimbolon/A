...
//public class ItemAllAdapter (var context:Context, var list:ArrayList<Detail>, var monlistener:OnNoteListener) :
...
//            list[p1]!!.id_produk.toInt(),
//            list[p1]!!.judul_produk,
//            list[p1]!!.harga_diskon.toDouble(),
////            list[p1]!!.deksripsi,
//            list[p1]!!.foto,
//            list[p1]!!.foto_type,
//            list[p1]!!.diskon.toDouble(),
//            list[p1]!!.harga_normal.toDouble(),
//            list[p1]!!.stok.toDouble(),
//            this.monlistener
//        )
//
...
//    }
//
////    fun setFilter(filterList: ArrayList<Detail>) {
////        var arrayList:ArrayList<Detail> = ArrayList()
